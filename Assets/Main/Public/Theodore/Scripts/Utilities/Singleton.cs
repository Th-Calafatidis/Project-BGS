...
//
// Description: A utility script that holds Static Instance / Singleton classes from which other classes can inherit from.
//              Used to save time and use those instead of creating them from scratch.
//
// Note: This is a custom script i have created and use in most of my projects. The code has been created outside of the task window.
